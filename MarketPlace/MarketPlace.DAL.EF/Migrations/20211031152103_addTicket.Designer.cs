...
namespace MarketPlace.DAL.EF.Migrations
{
    ...
    [Migration("20211031152103_addTicket")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketPlace.Domain.Entites.Contacts.Ticket", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MarketPlace.Domain.Entites.Contacts.TicketMessage", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MarketPlace.Domain.Entites.Contacts.Ticket", b =>
                {
                    b.HasOne("MarketPlace.Domain.Entites.Account.User", "Owner")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("MarketPlace.Domain.Entites.Contacts.TicketMessage", b =>
                {
                    b.HasOne("MarketPlace.Domain.Entites.Account.User", "Sender")
                        .WithMany("TicketMessages")
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MarketPlace.Domain.Entites.Contacts.Ticket", "Ticket")
                        .WithMany("TicketMessages")
